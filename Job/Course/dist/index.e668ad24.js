...
function createWBElements() {
    const mainContainer = (0, _moduleJs.createPageElement)("div", "wb-container", root, "", "", ""); //главный контейнер
    const headerWB = (0, _moduleJs.createPageElement)("div", "wb-header", mainContainer, "", "", ""); //хеадер
    const logoWB = (0, _moduleJs.createPageElement)("img", "wb-header__wblogo", headerWB, "", "", ""); //логотип
    const searchWB = (0, _moduleJs.createPageElement)("input", "wb-header__search", headerWB, "", "", "\u041F\u043E\u0438\u0441\u043A..."); //поле поиска
    ...
    searchWB.addEventListener("input", ()=>{
        ...
        Array.from(cardsList).forEach((elem)=>{
            if (!elem.lastChild.lastChild.textContent.toLocaleLowerCase().includes(searchValue)) elem.style.display = "none";
    ...
    sliderWB.innerHTML = `<div id="carouselExampleIndicators" class="carousel slide">
            ...
            <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <img class="carousel__img" src="https://loremflickr.com/640/480/food?random=3" alt="logo">
                    </div>
            </div>
...
},{}]},["jU1rT","3LleC"], "3LleC", "parcelRequiree79c")
